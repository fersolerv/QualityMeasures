...
private:
    ...
    bool read_points(pcl::PointCloud<pcl::PointXYZ>::Ptr &C_Object, pcl::PointCloud<pcl::Normal>::Ptr &Normals);

    void cloud_filter(pcl::PointCloud<pcl::PointXYZ>::Ptr Original, pcl::PointCloud<pcl::PointXYZ>::Ptr &Filtered);

    void getGraspQuality(const char *absPath1, const char *absPath3);

    void getTransforms(const char *absPath, const char *absPath2);
    ...
    void ModelConstruct2(pcl::PointCloud<pcl::PointXYZ>::Ptr Points_out, double &object_area);
